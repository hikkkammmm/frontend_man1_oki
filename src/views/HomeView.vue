...
const beritaList = [
  { id: 1, title: 'Juara 1 Olimpiade Sains Nasional', desc: 'Siswa MAN 1 OKI kembali mengukir prestasi di kancah nasional dalam bidang Fisika.', date: '24 Apr 2026', img: activityImg },
  { id: 2, title: 'Peringatan Hari Guru Nasional 2026', desc: 'Upacara dan pentas seni dalam rangka memeriahkan hari guru nasional. Berbagai kegiatan menarik disajikan.', date: '25 Nov 2025', img: heroImg },
  { id: 3, title: 'Kunjungan Edukasi ke Universitas Indonesia', desc: 'Membuka wawasan siswa kelas 12 dengan melakukan kunjungan ke kampus UI.', date: '10 Nov 2025', img: activityImg }
]
...
const kegiatanList = [
  { id: 1, name: 'Pramuka', icon: '⛺' },
  { id: 2, name: 'Rohis', icon: '🕌' },
  { id: 3, name: 'Paskibra', icon: '🇮🇩' },
  { id: 4, name: 'PMR', icon: '⚕️' },
  { id: 5, name: 'Karya Ilmiah Remaja', icon: '🔬' },
  { id: 6, name: 'Olah Raga', icon: '⚽' }
]

const galeriList = [
  heroImg, activityImg, heroImg, activityImg, heroImg, activityImg
]
</script>
  ...
  <div class="home">
    ...
    <section class="hero">
      ...
      <div class="container hero-content animate-fade-in-up">
        ...
        <p class="hero-subtitle">Membentuk generasi penerus bangsa yang islami, cerdas, terampil, dan berwawasan lingkungan.</p>
        <div class="hero-actions">
          <RouterLink to="/profil/visi-misi" class="btn btn-primary">Kenali Kami Lebih Dekat</RouterLink>
          <a href="#pengumuman" class="btn btn-outline" style="color: white; border-color: white;">Lihat Pengumuman</a>
        </div>
      </div>
    </section>
        ...
        <div class="sambutan-grid">
          ...
          <div class="sambutan-content animate-fade-in-up">
            ...
            <div class="sambutan-text">
              ...
              <p>Segala puji bagi Allah SWT Tuhan semesta alam, yang telah memberikan karunia-Nya sehingga website profil Madrasah Aliyah Negeri 1 Ogan Komering Ilir ini dapat hadir di hadapan bapak/ibu sekalian.</p>
              <p>Di era digital ini, website madrasah merupakan pintu gerbang informasi yang sangat fital. Kami berharap dengan optimalisasi digitalisasi pendidikan, madrasah kita dapat terus meningkatkan pelayanan pendidikan, mencetak lulusan yang tidak hanya cerdas secara intelektual, tapi juga matang secara spiritual.</p>
              <p>Wassalamu'alaikum Warahmatullahi Wabarakatuh.</p>
            </div>
            <RouterLink to="/profil/kepala-sekolah" class="read-more">Baca Profil Lengkap <span>→</span></RouterLink>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="grid cards-grid">
          <div v-for="berita in beritaList" :key="berita.id" class="card berita-card group">
            <div class="berita-img-wrapper">
              <img :src="berita.img" :alt="berita.title" class="berita-img">
              <div class="berita-date">{{ berita.date }}</div>
            </div>
            <div class="berita-content">
              <h3 class="berita-title">{{ berita.title }}</h3>
              <p class="berita-desc">{{ berita.desc }}</p>
      ...
      <div class="container">
        <div class="pengumuman-wrapper">
          <div class="pengumuman-header">
            ...
            <p class="text-muted mt-2">Informasi penting terkait akademik dan administrasi madrasah.</p>
          </div>
    ...
    <section class="section section-alt" id="galeri">
      <div class="container">
        <div class="flex justify-between items-center mb-8">
          ...
          <RouterLink to="/galeri" class="btn btn-outline" style="min-width: fit-content;">Lihat Semua</RouterLink>
        </div>
        <div class="galeri-grid">
          <div v-for="(img, index) in galeriList" :key="index" class="galeri-item">
            <img :src="img" alt="Dokumentasi Galeri" class="galeri-img">
...
.sambutan-image-wrapper:hover .sambutan-border {
...
@media (min-width: 1024px) {
  .kegiatan-grid { grid-template-columns: repeat(6, 1fr); }
}
...
.kegiatan-card:hover .kegiatan-name {
  color: white;
}
