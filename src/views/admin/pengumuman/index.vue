    ...
    <div class="mini-stats">
      ...
      <div class="mini-stat">
        <span class="ms-val green">{{
          store.list.filter((p) => p.status === 'active').length
        }}</span
        ><span class="ms-label">Aktif</span>
      </div>
      <div class="mini-stat">
        <span class="ms-val red">{{ store.list.filter((p) => p.status === 'expired').length }}</span
        ><span class="ms-label">Berakhir</span>
      </div>
    </div>
