      ...
      <div class="form-main">
        <div class="form-card">
          ...
          <div class="field">
            ...
            <input v-model="form.title" type="text" class="field-input" placeholder="Masukkan judul pengumuman..." id="pengumuman-title" />
          </div>
          <div class="field">
            <label class="field-label">Isi Pengumuman</label>
            <TipTapEditor v-model="form.content" placeholder="Tulis detail pengumuman di sini..." />
          </div>
        </div>
      </div>
