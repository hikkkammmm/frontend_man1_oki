...
const tenagaPendidik = [
  ...
  {
    id: 2,
    nama: 'Hj. Fatimah, S.Ag., M.Pd.I.',
    jabatan: 'Waka Kurikulum',
    mapel: "Al-Qur'an Hadits",
    kategori: 'guru',
    nip: '197205152003122003',
  },
  {
    id: 3,
    nama: 'Drs. Mahmud, M.Si.',
    jabatan: 'Guru Senior',
    mapel: 'Matematika',
    kategori: 'guru',
    nip: '196903201995121002',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    mapel: 'Akidah Akhlak',
    kategori: 'guru',
    nip: '196706011993032005',
  },
  {
    id: 7,
    nama: 'Rendra Aji, S.Pd.',
    jabatan: 'Guru',
    mapel: 'Penjaskes',
    kategori: 'guru',
    nip: '198203142010011014',
  },
  {
    id: 8,
    ...
    <section class="page-hero">
      ...
      <div class="container page-hero-content animate-fade-in-up">
        ...
        <p class="page-hero-subtitle">
          Para pendidik profesional yang berdedikasi dalam mencerdaskan generasi penerus bangsa.
        </p>
      </div>
    </section>
        ...
        <div class="guru-grid">
          <div v-for="g in filtered()" :key="g.id" class="guru-card card animate-fade-in-up">
            ...
            <div class="guru-info">
              ...
              <span class="guru-badge" :class="g.kategori">{{
                g.kategori === 'guru' ? 'Guru' : 'Staff'
              }}</span>
            </div>
          </div>
        </div>
...
.guru-badge.staff {
  background: rgba(193, 160, 89, 0.15);
  color: #8a6d28;
}
